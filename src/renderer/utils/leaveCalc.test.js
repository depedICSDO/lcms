...
import { annualLeaveRemaining, ctoBalance, ctoExpiryWarnings, leaveAvailability, monetizationEligibility, protectedVlBalance, retirementLeaveMonths } from './leaveCalc.js'
...
test('protected mandatory-leave credits are usable but excluded from monetization', () => {
  ...
  assert.equal(monetizationEligibility(employee, 'VL25_SL5').eligible, true)
...
test('includes only the configured Division non-teaching positions', () => {
